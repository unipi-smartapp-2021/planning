...
class RosStpNode():
    ...
    def run(self):
        ...
        rospy.Subscriber("/pose_stamped", PoseStamped, self.stp.update_car_status)
        rospy.Subscriber("/carla/ego_vehicle/vehicle_status", CarlaEgoVehicleStatus, self.stp.update_car_speed)
